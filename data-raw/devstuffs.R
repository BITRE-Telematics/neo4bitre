...
# The urls
my_desc$set("URL", "https://github.com/neo4j-rstats/neo4bitre")
my_desc$set("BugReports", "https://github.com/neo4j-rstats/neo4bitre/issues")
# Save everyting
